...
function loadQuiz() {
    ...
    a_txt.innerText = quizData[currentQuiz].a
    b_txt.innerText = quizData[currentQuiz].b
    c_txt.innerText = quizData[currentQuiz].c
    d_txt.innerText = quizData[currentQuiz].d
}
